...
<div class="sidebar">
    ...
    <a href="{{ route('admin.polls') }}">👥 İstifadəçilər</a>
...
<div class="content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2>Səsvermə aksiyasını redaktə et</h2>
    </div>
    ...
    <div class="row g-4">
        ...
        <form action="{{ route('admin.polls.update', $poll->id) }}" method="POST">
            ...
            <input type="text" class="form-control my-2" name="title" value="{{ $poll->title }}" required>
            <textarea class="form-control my-2" name="description" required>{!! $poll->description !!}</textarea>
